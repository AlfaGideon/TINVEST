...
//
// NOTE: раздел «Сигналы & Новости» работает ТОЛЬКО на реальных онлайн-данных
// (RSS-ленты СМИ + Polymarket Gamma API + живые котировки MOEX/Binance, см. news.js).
// Никаких захардкоженных новостей, симуляторов или демо-сценариев здесь нет.
